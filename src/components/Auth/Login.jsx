    ...
    <div className='flex h-screen w-screen items-center justify-center'>
        ...
        <form onSubmit={(e)=>{
            ...
            onChange={(e) => {
              ...
              required className='border-2 border-emerald-600 text-xl outline-none bg-transparent py-3 px-5 rounded-full placeholder:text-gray-400 mt-3' type="password" placeholder='Enter your password'/>
